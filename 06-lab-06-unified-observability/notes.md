...
**This lab:** **Unified** triage — one navigation model from metrics anomalies into traces and logs beats switching between Grafana, Datadog, and ad-hoc tools under incident pressure.
