...
**This lab:** **Cardinality** — Serverless does not remove the need for label discipline; Elastic plus OTEL processors help you **drop, aggregate, or roll up** before costs spike.
