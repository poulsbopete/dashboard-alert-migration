...
**This lab:** Grafana JSON and **PromQL** — a strong fit where Elastic exposes **PromQL-native** metric views, so you migrate panels instead of rewriting everything at once.
